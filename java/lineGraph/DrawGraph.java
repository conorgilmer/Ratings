...
public class DrawGraph extends JPanel {
   ...
   private static void createAndShowGui() {
     ...
     // int yvalues [] = {1212,1396,1454,1754,1652,1666};
      int yvalues [] = readDataFile("input.csv");
      int xvalues [] = {1,2,3,4,5,6};
      int maxDataPoints = 11;
      int maxScore = 1800;
      for (int i = 0; i < maxDataPoints ; i++) {
         scores.add(yvalues[i]);
 ...
 /* read from a file and print on screen */
      private static int [] readDataFile(String filename) {
              try {
			int i [] = new int[11]  ;
			int p =0;
